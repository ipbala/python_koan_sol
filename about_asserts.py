...
class AboutAsserts(Koan):
    ...
    def test_assert_truth(self):
        ...
        #Change 1 replace False with True
    ...
    def test_assert_with_message(self):
        ...
        """
        #Change 2. Replace Flase with True
    ...
    def test_fill_in_values(self):
        ...
        """
        # This is assert equal to val1 should be equal to val2
    ...
    def test_assert_equality(self):
        ...
        reality.
        """
        #expected_value should be 2 (1+1)
        expected_value = 2
        actual_value = 1 + 1
    ...
    def test_a_better_way_of_asserting_equality(self):
        ...
        """
        #expected_value should be 2 (1+1), Notice the assertE
        expected_value = 2
        actual_value = 1 + 1
